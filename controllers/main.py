...
class Academy(http.Controller):
	...
	@http.route('/classes', auth='public', methods=['get'])
	def index(self):
	...
	@http.route('/classes/register/<int:id>', auth='public', methods=['get'])
	def form(self, id):
		mode = http.request.env['training.center.class']
		classes = mode.search([['state', '=', 'open']])
	...
	@http.route('/classes/register', auth='public', methods=['get'])
	def form_empty(self):
		mode = http.request.env['training.center.class']
		classes = mode.search([['state', '=', 'open']])
		return http.request.render('training_center.form', {
	...
	@http.route('/classes', auth='public',methods=['post'])
